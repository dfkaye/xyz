...
function load(request) {
  ...
  ////////////////////////////////////////////////////
  //
  // load.pending is created only if load is called
  //
  // ready() down below must refer to load.pending && load.pending[id]
  //
  ////////////////////////////////////////////////////
  var pending = load.pending || (load.pending = []);
...
function ready(fn, monad) {
  ...
  //
  /////////////////////////////////////////
  var p = load && load.pending && load.pending[monad.module.id];
