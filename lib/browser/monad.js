...
function script(src, callback) {
  // callback required - assert(typeof callback == 'function', 'callback required');
...
function attach(src, callback) {
  ...
  // make this mandatory - assert(typeof callback == 'function', 'no callback');
  if (typeof callback == 'function') {
    ...
    ///////////////////////////////
    //
    // MORE TODO HERE RE ERRORS
    // http://www.quirksmode.org/dom/events/error.html
    //
    ///////////////////////////////
    s.onerror = function (e) {
      console.error('script error: ' + src);
      
      // looks like request should be its own api or constructor
      // handleDomScriptAttachError(src, )
