...
function Context(filename, parent, module) {
  ...
  this.module = new Module(filename, parent); // PROBABLY A MISTAKE
...
// console.log(self.filename);
  ...
  // console.log('self imports ' + filename + ': ' + (!!Module._cache[filename].exports));
  // console.log('self imports ' + filename + ': ' + (!!child));
  //console.log(filename + ': ' + registry[filename]);
  // console.log('self exports: ' + self.module.exports);
// console.dir(self.module.exports);
