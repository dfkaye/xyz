/*
 * browser-side polyfill for assert, path.normalize, Module, require, plus a 
 * script loader for asynchronous requests.  'assert', 'module', 'path' and 
 * 'script' are registered into the module system polyfill at the bottom of this 
 * file.
 */
