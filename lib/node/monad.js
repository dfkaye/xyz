 ...
 * parse, load, and away...
 * processes the requested id, updates and returns the monad
 */
function string(id, monad) {

  // OR MAYBE WE SHOULD FORCE USERS TO FORMAT CORRECTLY???
  ...
  // cycles are forbidden, no matter that node.js supports them with proxies
